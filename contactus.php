...
<head>
    ...
    <title>Contact Us - Apna Bazaar</title>
...
<body>
    <nav>
        <div class="navbar">
            ...
            <div style="border-bottom: 5px solid orange;"><a href="contactus.php">Contact Us</a></div>
    ...
    <div class="container">
        ...
        <form id="contactForm" action="contactusdb.php" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="feedback" name="message" rows="4"></textarea>
            </div>
            <p id="message1"></p>
            <button type="submit" class="btn btn-primary submit3">Submit</button>
        </form>
    </div>
    ...
    <script>
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (name == "" || email == "" || feedback == "") {
                ...
                // Delay form submission using setTimeout
                setTimeout(function() {
                    // Submit the form
                    contactForm.submit();
                }, 3000);
